  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        <section className="oslo-gradient norse-pattern py-24 text-center px-4">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="faq" className="max-w-5xl mx-auto">
              <div className="text-center mb-10">
                <h2 className="text-4xl font-bold text-viking-charcoal tracking-tight mb-4 relative inline-block after:content-[''] after:block after:h-1 after:w-24 after:bg-viking-red after:rounded-full after:mx-auto after:mt-4">
                  Frequently Asked Questions
                </h2>
                <p className="text-viking-charcoal/70 max-w-2xl mx-auto text-sm sm:text-base">
                    {/* Text here if you want it */}
                </p>
              </div>
              <div className="bg-white/80 backdrop-blur-sm border border-viking-red/10 shadow-xl rounded-xl p-4 sm:p-8">
                <Accordion type="single" collapsible className="space-y-2">
                  <AccordionItem
                    value="item-1"
                    className="rounded-lg border border-gray-200 bg-gray-50 overflow-hidden"
                  >
                    <AccordionTrigger className="px-4 sm:px-6 text-left text-viking-charcoal font-semibold text-base sm:text-lg">
                      Do I need prior experience?
                    </AccordionTrigger>
                    <AccordionContent className="px-4 sm:px-6 text-gray-600 text-sm leading-relaxed">
