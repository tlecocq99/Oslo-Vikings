    ...
    <section className="w-full bg-gray-50 dark:bg-viking-charcoal/70 border-b border-gray-200 dark:border-gray-700 py-3 md:py-4 transition-colors">
      <div className="w-full px-4 sm:px-4 lg:px-6">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-6">
          <div className="flex items-center justify-between md:block md:mr-2">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-bold text-base md:text-lg text-viking-red uppercase tracking-wide">
                Upcoming Events
              </h2>
            </div>
            <select
              ...
              className="mt-2 block w-full rounded-full border border-gray-300 bg-white py-1.5 px-3 text-sm font-teko tracking-[0.3em] text-viking-red focus:outline-none focus:ring-2 focus:ring-viking-red dark:border-gray-600 dark:bg-black dark:text-viking-red md:hidden"
            >
        ...
        <div className="relative mt-3 md:mt-0">
          ...
          <div
            ref={scrollRef}
            className="flex gap-3 overflow-x-auto scrollbar-hide py-1 md:py-0"
